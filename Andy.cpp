...
void check()
{
  ...
  {
    x.typing("Hi siddhi, how can I help you..");
  }
  else if (m_word == "play")
  {
    if (input == "play" || input == "play " || s_word == " " || s_word == "  " || s_word == "   ")
    {
      x.speak("Sorry Siddhi ,you did not enter song name");
      // tutorial("play");
    }
    else
    {
  ...
  {
    x.speak("Good bye, Siddhi");
    Sleep(600);
    cout << "\n\n\n\n\n\n\t\t\t\t\t";
    x.typing("Created By : Siddhi Singh");
    Sleep(1500);
    exit(1);
  }
  ...
  else if (m_word == "what" || m_word == "who" || m_word == "how" || m_word == "when" || m_word == "where" || m_word == "why")
  {
    ...
    {
      x.typing("I am Andy, a virtual assistant");
      Sleep(300);
      line();
      x.typing("Siddhi singh has made me.");
      Sleep(300);
      line();
  ...
  {
    x.speak("Sorry Siddhi, unknown command...");
    cnt++;
    if (cnt >= 3)
    { Sleep(600);
      x.speak("I think ");
